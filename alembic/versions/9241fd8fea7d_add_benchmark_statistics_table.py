...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('bm_std_deviation', sa.Float),
        sa.Column('bm_positive_periods', sa.Integer),
        sa.Column('bm_negative_periods', sa.Integer),
        sa.Column('bm_average_daily_return', sa.Float)
    )
